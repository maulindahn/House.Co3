package com.example.hana.rentcostumes.adapter;
...
import com.example.hana.rentcostumes.activity.MainActivity;
import com.example.hana.rentcostumes.view.LoadingFeedItemView;
...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static class CellFeedViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.ivFeedCenter) ImageView ivFeedCenter;
        @BindView(R.id.ivFeedBottom) ImageView ivFeedBottom;
        @BindView(R.id.btnComments) ImageButton btnComments;
        @BindView(R.id.btnLike) ImageButton btnLike;
        @BindView(R.id.btnMore) ImageButton btnMore;
        @BindView(R.id.vBgLike) View vBgLike;
        @BindView(R.id.ivLike) ImageView ivLike;
        @BindView(R.id.tsLikesCounter) TextSwitcher tsLikesCounter;
        @BindView(R.id.ivUserProfile) ImageView ivUserProfile;
        @BindView(R.id.vImageRoot) FrameLayout vImageRoot;
