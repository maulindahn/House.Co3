...
import com.example.hana.rentcostumes.adapter.CommentsAdapter;
import com.example.hana.rentcostumes.view.SendCommentButton;
...
public class CommentsActivity extends BaseDrawerActivity implements SendCommentButton.OnSendClickListener {
    ...
    @BindView(R.id.btnSendComment) SendCommentButton btnSendComment;
